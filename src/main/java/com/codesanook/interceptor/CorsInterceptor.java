...
public class CorsInterceptor extends HandlerInterceptorAdapter {
    ...
    private Log log = LogFactory.getLog(CorsInterceptor.class);
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        log.debug("CorsInterceptor called");
        if (this.corsData.isPreflighted()) {
            log.debug("isPreflighted");
            ...
            return false;//stop return immediately
        }

        log.debug("not isPreflighted");
        return true;
    }
